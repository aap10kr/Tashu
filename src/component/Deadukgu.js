...
const Deadukgu =()=>{
  ...
  async function getData(){
    const url = `http://apis.data.go.kr/B552061/frequentzoneBicycle/getRestFrequentzoneBicycle?ServiceKey=${API_KEY}&searchYearCd=${selectValue}&siDo=30&guGun=230&type=json&numOfRows=20&pageNo=1`
